...
class NotesHabitPage extends StatefulWidget {
  const NotesHabitPage({Key? key}) : super(key: key);

  @override
  State<NotesHabitPage> createState() => _NotesHabitPageState();
}

class _NotesHabitPageState extends State<NotesHabitPage> {
